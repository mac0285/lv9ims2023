                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                            <div class="grid grid-cols-1">
                                <label for="ip_comp" class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">IP (192.168.xx.xx)</label>
                                    <select  wire:model="ip_comp" type="" class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" name="ip_comp" required>>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                            ...
                            <div class="col-span-6 sm:col-span-4">
                                <label   class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Photo</label>
