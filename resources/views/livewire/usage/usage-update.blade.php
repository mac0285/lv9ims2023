...
<div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
    ...
    <label for="inbound" class="block text-gray-700 text-sm font-bold mb-2">Update ISP</label>
                    ...
                    <div class="">
                        ...
                        <div class="grid grid-cols-1">
                            <label for="inbound" class="block text-gray-700 text-sm font-bold mb-2">ISP</label>
                                <select id="Connection" wire:model="Connection" type="" class="py-2 px-3 bg-gray-200 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" name="Connection" disabled>
                        ...
                        <div class="grid grid-cols-1">
                            ...
                            <select id="type" wire:model="type" type="" class="py-2 px-3 bg-gray-200 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" name="type" disabled>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                            <div class="grid grid-cols-1">
                                ...
                                <input class="py-2 px-3 bg-gray-200 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" type="date" id="month_date" placeholder="Enter Month" wire:model="month_date" disabled>
