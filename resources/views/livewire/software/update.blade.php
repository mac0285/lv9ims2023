                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                            <div class="grid grid-cols-1">  
                                ...
                                <input class="py-2 px-3 bg-gray-200 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"type="text" id="sku" placeholder="Enter SKU" wire:model="sku" disabled>
                                @error('sku') <span class="text-red-500">{{ $message }}</span>@enderror
                            </div>
                            <div class="grid grid-cols-1">  
                                <label for="type" class="block text-gray-700 text-sm font-bold mb-2">Type</label>
                                <input class="py-2 px-3 bg-gray-200 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"type="text" id="type" placeholder="Enter Type" wire:model="type" disabled>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">    
                            ...
                            <textarea class="py-2 px-3 bg-gray-200 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" disabled
