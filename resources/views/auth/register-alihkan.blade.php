        ...
        <div class="font-sans">    
            <div class="relative min-h-screen flex flex-col sm:justify-center items-center">
                <div class="relative sm:max-w-sm w-sm">
                    ...
                    <label for="" class="block mt-3 text-sm text-red-400 text-center font-semibold "> 
                    <img class="w-16 md:w-16 lg:w-16  text-white " stroke="currentColor" src="{{ asset('img/anggun.ico') }}" alt="logo company" title="logo company"> Asset Management System</label>
                    @if (session('status'))
